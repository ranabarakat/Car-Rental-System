...
if(isset($_POST['go'])){
    ...
    $cemail=$_SESSION['email']= $_POST["email"];
			...
			<form name="myform" action="" onsubmit="return validateForm()" method="post">
				...
				<div style="background:lightgrey;opacity:90%; " >
					...
					<div class="form-group">
                            ...
                            <label style="width:20%;font-size:20;color:black;margin-left:20%" class="form-control-plaintext" >Customer's email:</label>
							<input style="width:25%;font-size:20;color:black;margin-left:20%"type='email' class="form-control" name="email" title="email" id="email"/>
                        </div>
