	...
	<body class="modal-body">
		<div>
			<form name="myform" action="" onsubmit="return validateForm()" method="post">
				<br><br><br>
				<h2 style="color:white; text-align:center">Enter the dates to get Daily Payments in this period</h2>

				<div style="background:lightgrey;opacity:90%; " >


					<div class="form-group">
							<label style="width:20%;font-size:20;color:black;margin-left:20%" class="form-control-plaintext" >Enter a Date:</label>
