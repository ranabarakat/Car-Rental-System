...
session_start();
if(isset($_POST['go'])){
    $startdate1=$_SESSION['start'] = $_POST["start"];
    $enddate1 =$_SESSION['end']= $_POST["end"];
    $platenumber=$_SESSION['plateno']= $_POST["plateno"];
	...
	<body class="modal-body">
		<div>
			<form name="myform" action="" onsubmit="return validateForm()" method="post">
				<br><br><br>
				<h2 style="color:white; text-align:center">Enter the dates to get reservation for a certain car</h2>
				...
				<div style="background:lightgrey;opacity:90%; " >
					...
					<div class="form-group">
                            ...
                            <label style="width:20%;font-size:20;color:black;margin-left:20%" class="form-control-plaintext" >Car's plate number:</label>
							<input style="width:25%;font-size:20;color:black;margin-left:20%"type='number' class="form-control" name="plateno" title="plateno" id="plateno"/>
                        </div>
